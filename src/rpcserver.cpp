...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Dequant server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dequant features */
        {"dequant", "masternode", &masternode, true, true, false},
        {"dequant", "listmasternodes", &listmasternodes, true, true, false},
        {"dequant", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dequant", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dequant", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"dequant", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"dequant", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"dequant", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dequant", "masternodedebug", &masternodedebug, true, true, false},
        {"dequant", "startmasternode", &startmasternode, true, true, false},
        {"dequant", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dequant", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dequant", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dequant", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dequant", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dequant", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dequant", "mnbudget", &mnbudget, true, true, false},
        {"dequant", "preparebudget", &preparebudget, true, true, false},
        {"dequant", "submitbudget", &submitbudget, true, true, false},
        {"dequant", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dequant", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dequant", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dequant", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dequant", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dequant", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dequant", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dequant", "checkbudgets", &checkbudgets, true, true, false},
        {"dequant", "mnsync", &mnsync, true, true, false},
        {"dequant", "spork", &spork, true, true, false},
        {"dequant", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzdeqseed", &getzdeqseed, false, false, true},
        {"zerocoin", "setzdeqseed", &setzdeqseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdeq", &searchdzdeq, false, false, true},
        {"zerocoin", "dzdeqstate", &dzdeqstate, false, false, true}
...
{
    return "> dequant-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:6113/\n";
}
