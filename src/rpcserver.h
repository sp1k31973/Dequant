...
/**
 * Dequant RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzdeqseed(const UniValue& params, bool fHelp);
extern UniValue getzdeqseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzdeq(const UniValue& params, bool fHelp);
extern UniValue dzdeqstate(const UniValue& params, bool fHelp);
