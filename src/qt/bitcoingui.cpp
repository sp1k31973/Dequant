                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dequant Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dequant address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dequant: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDEQ"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dequant Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dequant Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dequant"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dequant addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dequant addresses"));
    ...
    openAction->setStatusTip(tr("Open a Dequant: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dequant Core help message to get a list with possible Dequant command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Dequant Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dequant network", "", count));
}
...
{
    QString strTitle = tr("Dequant Core"); // default title
