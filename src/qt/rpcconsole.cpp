                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDEQPathCustom = GetArg("-zdeqbackuppath", "");
    ...
    if(!strzDEQPathCustom.empty()) {
        ui->wallet_customzdeqbackuppath->setText(QString::fromStdString(strzDEQPathCustom));
        ui->wallet_customzdeqbackuppath_label->setVisible(true);
        ui->wallet_customzdeqbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDEQPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Dequant RPC console.") + "<br>" +
