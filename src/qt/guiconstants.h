...
/* Dequant GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Dequant"
#define QAPP_ORG_DOMAIN "dequant.org"
#define QAPP_APP_NAME_DEFAULT "Dequant-Qt"
#define QAPP_APP_NAME_TESTNET "Dequant-Qt-testnet"
