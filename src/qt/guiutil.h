...
/** Utility functions used by the Dequant Qt UI.
 */
namespace GUIUtil
{
...
// Render Dequant addresses in monospace font
...
// Parse "dequant:" URI into recipient object, return true on successful parsing
