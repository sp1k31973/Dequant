...
In order to support loading of multiple wallets in dequant-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dequant.cpp.
...
Changes to dequant.cpp
----------------------
dequant.cpp is the entry point into dequant-qt, and as such, will require some minor modifications to provide hooks for
