...
#   c) node1 mines 32 blocks, so now node 0 has 60001deq, node 1 has 4250deq, node2 has none.
#   d) node0 sends 601 deq to node2, in two transactions (301 deq, then 300 deq).
