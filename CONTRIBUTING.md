Contributing to Dequant Core
============================

The Dequant Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Dequant Core project, and is not to be
confused with overall Dequant Network Protocol consensus changes.

Whether a pull request is merged into Dequant Core rests with the project merge
...
Patches that change Dequant consensus rules are considerably more involved than
...
Where a patch set proposes to change the Dequant consensus, it must have been
...
The project leader is the release manager for each Dequant Core release.
