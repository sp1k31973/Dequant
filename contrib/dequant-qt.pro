...
RESOURCES += src/qt/dequant.qrc src/qt/dequant_locale.qrc

TRANSLATIONS += src/qt/locale/dequant_bg.ts \
                src/qt/locale/dequant_de.ts \
                src/qt/locale/dequant_en.ts \
                src/qt/locale/dequant_es.ts \
                src/qt/locale/dequant_fi.ts \
                src/qt/locale/dequant_fr.ts \
                src/qt/locale/dequant_it.ts \
                src/qt/locale/dequant_ja.ts \
                src/qt/locale/dequant_pl.ts \
                src/qt/locale/dequant_pt.ts \
                src/qt/locale/dequant_ru.ts \
                src/qt/locale/dequant_sk.ts \
                src/qt/locale/dequant_sv.ts \
                src/qt/locale/dequant_vi.ts \
                src/qt/locale/dequant_zh_CN.ts \
                src/qt/locale/dequant_zh_TW.ts
